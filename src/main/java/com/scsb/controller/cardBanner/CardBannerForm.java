...
public class CardBannerForm 
{
	...
	private MultipartFile imageMobileFile;
	...
	public MultipartFile getImageMobileFile() {
		return imageMobileFile;
	}

	public void setImageMobileFile(MultipartFile imageMobileFile) {
